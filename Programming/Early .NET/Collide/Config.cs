...
public class Config : System.Windows.Forms.Form
{
    ...
    public Config(BounceWnd bounceWnd, Setup setup)
    {
		...
		toolTip1.SetToolTip(txName, "Name to use for this setting");
...
/*    public override void Dispose()
    ...
    */
	...
	private void InitializeComponent()
	{
		...
		this.txName.Location = new System.Drawing.Point(288, 88);
		this.txName.Size = new System.Drawing.Size(208, 20);
		this.txName.TabIndex = 3;
		this.txName.Text = "textBox1";
